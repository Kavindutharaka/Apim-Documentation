# Migrating from WSO2 EI 6.2.x to WSO2 API-M 4.2.0

This guide provides the recommended strategy for upgrading from the ESB profile of WSO2 EI 6.2.0 to the Micro Integrator of WSO2 API-M 4.2.0.
...
- If the artifacts are created using the management console of EI 6.2.0, you need to recreate them using WSO2 Integration Studio and package them as a composite application. See the instructions on [packaging artifacts](https://apim.docs.wso2.com/en/4.2.0/integrate/develop/packaging-artifacts).
...
- If the connector is added to EI 6.2.0 via the management console, pack them using the [Connector Exporter Project](https://apim.docs.wso2.com/en/4.2.0/integrate/develop/creating-artifacts/adding-connectors) and deploy via a composite application in the Micro Integrator.
...
Given below are some of the most critical XML configuration files in the ESB profile of EI 6.2.0. Expand each section to find the TOML configurations corresponding to the XML configurations in the file.
...
In case you need to obtain the plain-text passwords by decrypting the encrypted passwords in the EI 6.2.0, you can use the password decryption tool. Contact WSO2 Support to obtain this tool.

Follow the instructions given below to use the password decryption tool.

1. Contact WSO2 Support to obtain the migration tool.
...
4. Contact WSO2 Support to obtain the migration-conf.properties file if you do not have it and copy it into the `migration` directory and update the following property.
