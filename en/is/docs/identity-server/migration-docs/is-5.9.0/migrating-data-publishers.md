...
-   **Old design approach**
    ![<Old design approach>](https://is.docs.wso2.com/en/5.9.0/assets/img/setup/old-design-approach.png)
-   **New design approach**
    ![<New design approach>](https://is.docs.wso2.com/en/5.9.0/assets/img/setup/new-design-approach.png)
...
1.  If you have enabled `org.wso2.carbon.identity.data.publisher.application.authentication.impl.DASSessionDataPublisherImpl`
    ...
    >   **Note**
    >
    >   For the new configuration model in WSO2 Identity Server 5.9.0, see [New Configuration Model](https://is.docs.wso2.com/en/5.9.0/references/new-configuration-model) for more information.
    >
...
3.  To enable the new event handler, add handler and relevant property
    ...
    >   For more information on new configurations, see 
        [New Configuration Model](https://is.docs.wso2.com/en/5.9.0/references/new-configuration-model).
